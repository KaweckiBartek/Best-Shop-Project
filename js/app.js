...
//
// const packageForm = document.getElementById("package")
//
//
// const summaryProductsForm = document.querySelector("[data-id=products]" );
//
// const summaryOrdersForm = document.querySelector("[data-id=orders]" );
//
// const summaryPackageForm = document.querySelector("[data-id=package]" );
//
// const summaryAccountingForm = document.querySelector("[data-id=accounting]" )
//
// const summaryTerminalForm = document.querySelector("[data-id=terminal]" )
//
// const summaryTotalForm = document.getElementById("total-price")
//
//
//
// productsForm.addEventListener("keypress", showCalcForm(summaryProductsForm))
//
//
// function showCalcForm (element){
//
//     if (productsForm.value.length === 1){
//        return element.classList.add("open");
//
//     }else if (productsForm.value.length === 0){
